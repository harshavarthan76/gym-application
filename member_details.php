...
<div class="card">
    ...
    <a href="admin-panel.php" class="btn btn-secondary ">Go Back</a>
         ...
         <form class="form-group" action="member_search.php" method="post">
          <div class="row">
   <div class="col-md-10"><input type="text" name="search" class="form-control" placeholder="Enter Gym Id or Name "></div>
              <div class="col-md-2"><input type="submit" name="patient_search_submit" class="btn btn-secondary" value="Search"> </div></div>           
                 </form></div></div></div> -->
