...
if(isset($_POST['pat_submit']))
{
    ...
    $query="insert into members(gym_id,name,father_name,email,date_of_joining,contact,last_payment,payment_status)values('$gym_id','$name','$fname','$email','$date_of_joining','$contact','$last_payment', '$status')";
     $result=mysqli_query($con,$query);
    if($result)
    {
    ...
    //     } 
        if(isset($_POST['pay_submit']))
        {
         $gym_id=$_POST['gym_id'];
            ...
            $query="UPDATE members SET  last_payment= '$date_of_payment', payment_status = '$status' 
