...
INSERT INTO `members` (`gym_id`, `name`, `father_name`, `email`,`date_of_joining`, `contact`, `last_payment`) VALUES
...
INSERT INTO `payments` (`gym_id`, `name`,  `payment_type`, `date_of_payment`) VALUES
